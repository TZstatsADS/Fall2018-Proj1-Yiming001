...
I can see there are two outliers, now I select these two countries to see which two countries are. From the datatable, I can see top two countries are USA and IND (Frequency: larger than 10000), others are less than 600, so small, indicating I can split into three categories.
```{r,echo = FALSE, warning=FALSE, message=FALSE}
...
Beside the sentiments analysis, I did basic topic modeling for the 3 country groups. Firstly, I created a document term matrix.
After generating the document-term-matrix, I started LDA. I chose 7 topics since the original dataset happy has 7 predicted_categories. After running LDA, I checkd the per-document-per-word probability for each group.
